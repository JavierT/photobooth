...
class TornadoApplication(tornado.web.Application):
    ...
    def __init__(self):
        ...
        self.th_wait_and_capture = threading.Thread(target=wait_and_capture, self.running)
        self.th_wait_and_capture.start()
        self.th_btns_input = threading.Thread(target=process_btn_action, self.running)
